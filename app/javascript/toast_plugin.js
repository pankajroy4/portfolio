...
(function ($) {
  ...
  var createToastContainer = function () {
    var toastContainer = $("<div>")
      .addClass("custom-toast-container")
  ...
  var createToast = function (settings) {
    ...
    switch (settings.type) {
      case "success":
        iconColor = "#47D764";
        svgIcon =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM241 337l-17 17-17-17-80-80L161 223l63 63L351 159 385 193 241 337z"></path></svg>';
        break;
      case "error":
        iconColor = "#ff355b";
        svgIcon =
      ...
      case "info":
        iconColor = "#2F86EB";
        svgIcon =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216 192V224h24 48 24v24 88h8 24v48H296 216 192V336h24zm72-144H224V128h64v64z"/></svg>';
        break;
      case "warning":
        iconColor = "#FFC021";
        svgIcon =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm24-384v24V264v24H232V264 152 128h48zM232 368V320h48v48H232z"/></svg>';
        break;
      default:
        iconColor = "#47D764";
        svgIcon =
