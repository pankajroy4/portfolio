class CreateSections < ActiveRecord::Migration[7.1]
  def change
    create_table :sections, id: :uuid do |t|
      ...
      t.jsonb :others, default: { email: "abc@gmail.com", phone: "+91 1234567890", typewriter: ["Pankaj Kumar 👋...", "Full Stack Developer", "Syntax & Stories", "Compiling Dreams"], btn_typewriter: ["⭐ Let’s Shine Together!", "⭐ Star It Now!"], cursor_style: "🔥", repository: "https://github.com/pankajroy4/portfolio", }
